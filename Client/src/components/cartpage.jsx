...
export default function CartPage({ cartData, changeQunty, remove_product }) {
    ...
    async function checkout(){
        if(cartData.totalPriceInCart<1){
            return toast.error("Cart empty")
        }
        instance.get("/user/cart/checkout").then((response) => {
        settoken(response.data.data);
        createCardOrder(response.data.data.id)
    })}
    
    const createCardOrder = async (id) => {
        var options = {
            ...
            "order_id": id,   ///token.id  //This is generated by razorpay on creating an order using instance.order.create
    ...
    return (
        ...
        <section>
                            ...
                            return (
                                <>
                                    <tr key={productdetails._id} style={{ height: '6rem' }}>
                                        <td><img style={{ marginTop: '0.2rem' }} src={productdetails.prodimg}
                                            alt="" /></td>
            ...
            <div class="CardAndCheckout">
                ...
                <div><button class="checkout" onClick={()=>checkout()} >Buy Now</button></div>
